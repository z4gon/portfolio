...
const data: ProjectData = {
    ...
    implementationDetails: [
        ...
        'Snow Meshes particles, with dissolve/fresnel shader.',
        'Spike Meshes particles, with dissolve/fresnel shader.',
        ...
        'Configurable colors, fresnel power, partiles size and count.',

!(function () {
                ...
                (g &&
                    ...
                    We !== Object.prototype &&
                        ...
                        (Te(u) !== We &&
                            (ze
                                ? ze(u, We)
                                : 'function' != typeof u[Ge] && T(u, Ge, Xe)),
                        Ne(u, l, !0))),
                o == Ve &&
                    d &&
                    d.name !== Ve &&
        ...
        zn = function (t) {
            return function (e) {
                for (
                    ...
                    (r = o[u++]),
                        (i && !qn.call(n, r)) || s.push(t ? [r, n[r]] : n[r])
                return s
            }
        },
        ...
        return [
            ...
            function (t, n) {
                ...
                for (var d = []; ; ) {
                    ...
                    if ((d.push(v), !h)) break
                    '' === String(v[0]) &&
                        (c.lastIndex = Di(f, ft(c.lastIndex), p))
                }
    ...
    var pa = wt.f,
        ...
        qa = function (t, e) {
            ...
            return (
                Aa(r, { type: Ea, tag: t, description: e }),
                i || (r.description = e),
                r
            )
        },
    ...
    if (
        (Nt ||
            ((ja = function () {
                ...
                return (
                    i && Ba && Da(Ra, e, { configurable: !0, set: r }), qa(e, t)
                )
            }),
    ...
    var iu,
        ...
        hu = su('endsWith'),
        pu = !(
            hu || ((iu = cu(String.prototype, 'endsWith')), !iu || iu.writable)
        )
    Lt(
    ...
    var gu =
        ...
        mu = function (t) {
            return function (e, r, n) {
                ...
                return c <= u || '' == s
                    ? a
                    : ((i = gu.call(s, yu((o = c - u) / s.length))).length >
                          o && (i = i.slice(0, o)),
                      t ? a + i : i + a)
            }
        },
                ...
                if (y(c))
                    if ('function' == typeof (t = hr(c)))
                        for (
                            ...
                            if (
                                (a = (i = (o = an(j(n.value))).next).call(o))
                                    .done ||
                                (u = i.call(o)).done ||
                                !i.call(o).done
                            )
    ...
    Br(
        ys,
        {
            ...
            delete: function (t) {
                ...
                for (
                    var e = es(this), r = e.entries, n = t + '', o = 0;
                    o < r.length;
        ...
        (i &&
            Wt(Pc, {
                ...
                port: qc(Nc, function (t) {
                    var e = Os(this)
                    tc(e) ||
                        ('' == (t = String(t)) ? (e.port = null) : Rc(e, t, yc))
                }),
    ...
    var sl = et.set,
        ...
        fl = function (t, e) {
            ...
            return (
                _r(t, n.push, n),
                i
                    ? sl(r, { errors: n, type: 'AggregateError' })
                    : (r.errors = n),
    ...
    if (gl)
        var yl = [
            ...
            ml =
                ...
                function (t) {
                    return (
                        t && yl.indexOf(Object.prototype.toString.call(t)) > -1
                    )
                }
    function bl(t) {
        if (
                ...
                ;(this._bodyInit = t),
                    t
                        ? 'string' == typeof t
                            ...
                            : gl &&
                              (ArrayBuffer.prototype.isPrototypeOf(t) || ml(t))
